...
CKFinder.lang['en'] =
{
	...
	// piranti
	pirantiFolder		: 'piranti',
	pirantiClear			: 'Clear piranti',
	pirantiRemove		: 'Remove from piranti',
	pirantiOpenFolder	: 'Open Parent Folder',
	pirantiTruncateConfirm : 'Do you really want to remove all files from the piranti?',
	pirantiRemoveConfirm	: 'Do you really want to remove the file "%1" from the piranti?',
	pirantiRemoveConfirmMultiple	: 'Do you really want to remove %1 files from the piranti?',
	pirantiEmpty			: 'No files in the piranti, drag and drop some.',
	pirantiCopyFilesHere	: 'Copy Files from piranti',
	pirantiMoveFilesHere	: 'Move Files from piranti',
